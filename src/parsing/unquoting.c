...
/*   Updated: 2024/03/25 14:17:15 by yroussea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_undoublequote(char *s, t_lst_envp *lst_envp)
{
	...
	return (ft_vjoin(2, "", res, ft_undolars(s, lst_envp)));
}
...
char	*ft_unsimplequote(char *s, t_lst_envp *lst_envp)
{
	...
	while (s && *s && *s != 39)
		s++;
	return (ft_vjoin(2, "", res, ft_unquote(s, lst_envp)));
}
...
char	*ft_unquote(char *s, t_lst_envp *lst_envp)
{
	...
	while (s && *s && *s != 34 && *s != 36 && *s != 39)
		s++;
	if (*s == 34)
		return (ft_vjoin(2, "", res, ft_undoublequote(s, lst_envp)));
	if (*s == 36)
		return (ft_vjoin(2, "", res, ft_undolars(s, lst_envp)));
	if (*s == 39)
		return (ft_vjoin(2, "", res, ft_unsimplequote(s, lst_envp)));
	return (res);
}
