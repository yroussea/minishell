...
/*   Updated: 2024/06/12 09:43:33 by yroussea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			*ft_unsimplequote(char *s, t_lst_envp *lst_envp, int inside_dollars);
char			*ft_undolars(char *s, t_lst_envp *lst_envp, int inside_dollars);
char			*ft_undoublequote(char *s, t_lst_envp *lst_envp, int inside_dollars);
